...
Commands cmds = {
                {"Calculated Engine Load", QCanBusFrame(0x7df, QByteArray::fromHex("0201040000000000")), percentage},
...
/*add-ons to original. Need to update other files                {"Engine Oil Temperature", QCanBusFrame(0x7df, QByteArray::fromHex("02015C0000000000")), temp}, 
                {"Fuel Tank Value", QCanBusFrame(0x7df, QByteArray::fromHex("02012F0000000000")), percentage}, 
                {"Throttle", QCanBusFrame(0x7df, QByteArray::fromHex("0201110000000000")), percentage},
                {"BOOST", QCanBusFrame(0x7df, QByteArray::fromHex("02010B3300000000")), pressure},
                {"Lambda 1", QCanBusFrame(0x7df, QByteArray::fromHex("0201240000000000")), lambdaValue}, 
                
                {"CAT TEMP 1", QCanBusFrame(0x7df, QByteArray::fromHex("02013C0000000000")), temp} 
                }; */
